...
const cardContent = [
  { front: 'How many Btyes in a Boolean?', back: 'Two'},
  { front: 'A first name is what data type?', back: 'String' },
  { front: 'Number four in binary', back: '0100' },
  { front: 'Boolean, date, integer and floating point are an example of?', back: 'Data Items' },
  { front: '(T/F) IPO stands for Input, Process, Output', back: 'True' },
];
